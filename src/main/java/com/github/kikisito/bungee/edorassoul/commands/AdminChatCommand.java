...
public class AdminChatCommand extends Command {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        try {
            ...
            Main.telegramBot.getTelegramBot().sendMessage(config.getString("adminchat-channel"), config.getString("chat.telegram-adminchannel").replace("{user}", sender.getName()).replace("{message}", message), ParseMode.MARKDOWN, false, false, null, null, null);
